...
dep_gen["spec"]["template"]["spec"]["containers"][0]["env"][2]["value"] = "0.001,0.001" #period 0.2
dep_gen["spec"]["template"]["spec"]["containers"][0]["env"][3]["value"] = "30,False" #batch
...
dep_gen["spec"]["template"]["spec"]["containers"][1]["env"][2]["value"] = "2500" #how many batch to send (int, inf)
